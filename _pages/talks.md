...
*<span style="font-size:0.8em">(<span style="color:deeppink"> <sup>**‡**</sup>: invited</span>)</span>*
## Seminars
...
* **Noisy pipes: how intermittent fluid transport in faults could be responsible
  ...
  <a href="https://www.youtube.com/watch?v=vmb4xFLTKNQ" target="_blank" class="btn btn--small" id="doi-btn">video</a>
* **Migrations and episodicity of tectonic tremor as symptoms of the intermittence of permeable
  fluid transport systems**
	* 29 June 2021 — ENS, Geology laboratory <span style="color:deeppink"><sup>***‡***</sup></span>
...
* **Clogging and un-clogging of the subduction plumbing system may generate tremor-like patterns** *(virtual poster)*  
  EGU General Assembly, 2021  
  <!-- <a "https://ui.adsabs.harvard.edu/abs/2021EGUGA..23.2124F/abstract"
  target="_blank" class="btn btn--small" id="doi-btn">abstract</a> -->
  <a href="https://meetingorganizer.copernicus.org/EGU21/EGU21-2124.html" target="_blank" class="btn btn--small" id="doi-btn">abstract</a>
  <a href="https://gfarge.github.io/files/virtualdisplayEGU21.pdf" target="_blank" class="btn btn--small" id="doi-btn">pdf</a>
* **Tectonic tremor without slip?**: Fast pore pressure transients in the subduction interface can generate tremor patterns *(virtual poster)*  
...
* **Sounds of the subduction piping system?** How the dynamics of transient pore pressure diffusion in subduction zones could account for low-frequency earthquakes activity *(poster)*  
...
* **Insights in low frequency earthquake source processes from observations of their size-duration scaling** *(talk)*  
